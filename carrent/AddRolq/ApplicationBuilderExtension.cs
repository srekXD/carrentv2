    ...
    public static class ApplicationBuilderExtension
    {
        public static async Task<IApplicationBuilder> PrepareDataBase(this IApplicationBuilder app)
        {
            ...
            try
            {
                ...
                var userManager = services.GetRequiredService<UserManager<Clieunt>>();
        ...
        public static async Task SeedSuperAdminAsync(UserManager<Clieunt> userManager)
        {
            //Seed Default User
            var defaultUser = new Clieunt
            {
                UserName = "superadmin",
